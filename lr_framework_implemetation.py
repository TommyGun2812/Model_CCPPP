...
#-------DATA SPLITTING-------#
# Primero train+temp, luego val+test
...
sgd = SGDRegressor(loss="squared_error", penalty=None, learning_rate="constant", eta0=0.01, max_iter=1, warm_start=True, random_state=42)
